...
# TODO:
# - Colocar o visitaCelula depois das verificações, afinal, se já passou para elas, então podemos considerar os indices já visitados
# - Debuggar passo a passo o código pra ver o que está acontecendo que o desvio de fluxo está mudando para algo que não quero
# - Guardar valores de t4-t5 na pilha depois das verificações daParaPassar/foiVisitado, pois durante a saída do fluxo vamos perder valores de a0-a1.
...
dfs:
    ...
    # Trecho de código novo para tentar parar a execução assim que chegarmos no valor desejado.
    # addi a0, a2, 0
    # addi a1, a3, 0
